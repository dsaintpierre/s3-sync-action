...
This is a fork of the Jake Jarvis S3 sync action for jobs in reverse- i.e., syncing files *from* s3 *to* github actions flows.
...
| `SOURCE_DIR` | The subdirectory in s3 you wish to pull from. | `env` | No | `./` (root of cloned repository) |
| `DEST_DIR` | The directory inside your project you wish to download to. For example, `my_project/assets`. Defaults to root. | `env` | No | `/` (root of bucket) |
